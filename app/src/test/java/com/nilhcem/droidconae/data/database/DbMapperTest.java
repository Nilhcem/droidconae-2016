package com.nilhcem.droidconae.data.database;

import android.os.Build;

import com.nilhcem.droidconae.BuildConfig;
import com.nilhcem.droidconae.core.moshi.LocalDateTimeAdapter;
import com.nilhcem.droidconae.data.app.AppMapper;
import com.nilhcem.droidconae.data.app.model.Room;
...
public class DbMapperTest {
    ...
    public void should_convert_db_sessions_to_app_sessions() {
        ...
        com.nilhcem.droidconae.data.database.model.Session session = new com.nilhcem.droidconae.data.database.model.Session(2, "now", 10, 3, "[1]", "title", "description");
        List<com.nilhcem.droidconae.data.database.model.Session> sessions = singletonList(session);
    ...
    public void should_convert_app_session_to_db_session() {
        ...
        Session session = new Session(11, Room.TRACK_1.name, speakers, "title", "description", now, now.plusMinutes(45));

        // When
        com.nilhcem.droidconae.data.database.model.Session result = dbMapper.fromAppSession(session);

        // Then
        assertThat(result.id).isEqualTo(11);
        assertThat(result.roomId).isEqualTo(Room.TRACK_1.id);
    ...
    public void should_convert_app_speaker_to_db_speaker() {
        ...
        // When
        com.nilhcem.droidconae.data.database.model.Speaker result = dbMapper.fromAppSpeaker(speaker);
    ...
    public void should_convert_db_speakers_to_app_speakers() {
        // Given
        com.nilhcem.droidconae.data.database.model.Speaker speaker = new com.nilhcem.droidconae.data.database.model.Speaker(58, "nilh", "dev", "bio", "nilhcem.com", "Nilhcem", "nilhcem", "photo");
