package com.nilhcem.droidconae.data.network;
...
import com.nilhcem.droidconae.data.network.model.Session;
import com.nilhcem.droidconae.data.network.model.Speaker;
...
public class NetworkMapperTest {
    ...
    public void should_convert_network_speakers_to_app_speakers() {
        ...
        // When
        List<com.nilhcem.droidconae.data.app.model.Speaker> result = networkMapper.toAppSpeakers(speakers);
    ...
    public void should_convert_network_sessions_to_app_sessions() {
        ...
        Session session = new Session(1, startAt, 20, Room.TRACK_1.id, singletonList(10), "title", "description");
        ...
        // When
        List<com.nilhcem.droidconae.data.app.model.Session> result = networkMapper.toAppSessions(singletonList(session), speakersMap);
        ...
        assertThat(result.get(0).getRoom()).isEqualTo(Room.TRACK_1.name);
